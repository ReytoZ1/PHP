    ...
    <div class="container-xxl  py-5 my-5" id="table">
        ...
        <div class="container py-5">
            ...
            <div class=" wow fadeInUp" data-wow-delay="0.1s">
                ...
                <p class=" fs-5 mb-0 " style=" text-align: justify;">Keputusan = Penghargaan pegawai terbaik diberikan kepada 3 pegawai dengan nilai akhir dan ranking teratas, yaitu:
                </p>
                <li class="list-group-item  fs-5">(1) Mulyadi Alzauhadi, SE, M.Si,</li>
                <li class="list-group-item  fs-5">(2) Harri Rakim, A.Ma,</li>
                <li class="list-group-item  fs-5">(3) Imam Faturochman, ST, M.Si.</li>
                <span class="fw-bold fs-4">Keputusan di atas bersifat mutlak.</span>
